...
def shortest_path(source, target):
    ...
    """Finds a solution to Baconator, if one exists."""
    ...
    while True:
            ...
            if node.state == target:
                stars = []
                movies = []
                """looping through sequnce to generate solution"""
                ...
                movies.reverse()
                stars.reverse()
                solution = [(movies[i], stars[i]) for i in range(0, len(stars))]
                return solution
